...
Stack * create ( int item ) {
  ...
  /*
  Because stack is empty top == base, 
  Creates space for amount of items * space for each item
  Creating the stack
  */
  stack->top = stack->base = (void **) malloc(item * sizeof(void *));
...
void * push (Stack *stack, void *element) {
  ...
  if (maxelements == (stack->top - stack->base)) {		//The stack top-base =stack size
    return (void *) NULL;
  }
