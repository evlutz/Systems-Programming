...
int main()
{
  ...
  */
  ...
  //Sean's code from here

  //struct Person creation and printing

  Person* person1 = make_person("Sean Arackal", 2004, 100000);
  Person* person2 = make_person("Brian Jin", 2004, 200000);
  Person* person3 = genRandomPerson();
  ...
  Person** personArray1 = genRandomPersonArray(3);
  printPersonArray(personArray1, 3);

  printf("\nPrinting random person array copy\n");
  Person** personArrayCopy = copyPersonArray(personArray1, 3);
  printPersonArray(personArrayCopy, 3);
  return 0;
}
